 ...
 *
 *   node docs/design/ux-review-2026-08-04/build.mjs
 *
...
const SECTIONS = [
  { id: 'a', file: 'section-a-composer.html', label: 'Composer' },
  { id: 'b', file: 'section-b-messages.html', label: 'Messages' },
  { id: 'c', file: 'section-c-toolcalls.html', label: 'Tool calls' },
  { id: 'd', file: 'section-d-terminal.html', label: 'Terminal & header' },
  { id: 'e', file: 'section-e-inbox.html', label: 'Inbox' },
  { id: 'f', file: 'section-f-tracking.html', label: 'Tracking' },
];
...
<html lang="en" data-theme="dark">
  <head>
    ...
    <title>loombox UX review, 2026-08-04</title>
    <style>
${read('_shell.css')}
