...
describe('buildClaudeImageContentBlock', () => {
  ...
  it('re-sniffs the bytes rather than trusting a declared mime type', () => {
    ...
    // "declared" mimeType at all — the function only ever emits the
    // sniffed one, which this proves against a JPEG-magic buffer too.
