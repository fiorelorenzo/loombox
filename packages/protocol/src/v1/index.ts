...
// The families below are fully exported above (public API) but were never pulled into this
// file's own re-export surface for `schemasV1` construction — issue #910's sweep: every one of
// these union members parses/routes correctly, they were just silently absent from the registry
// tooling reads for "the schema for type X" (the same class of gap #224 hit for
// `github_pat_connect_response`, caught only by accident there).
...
import { terminalResyncMarker } from './terminal';
