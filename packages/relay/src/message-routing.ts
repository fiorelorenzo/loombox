...
export const MESSAGE_ROUTES: { readonly [T in WireMessageV1['type']]: MessageRoute } = {
  ...
  agent_instructions_get_request: { routed: 'client' },
  agent_instructions_get_response: { routed: 'node' },
  agent_instructions_set_request: { routed: 'client' },
  agent_instructions_set_response: { routed: 'node' },
  git_branch_list_request: { routed: 'client' },
  git_branch_list_response: { routed: 'node' },
  git_branch_create_request: { routed: 'client' },
  git_branch_create_response: { routed: 'node' },
  git_branch_switch_request: { routed: 'client' },
  git_branch_switch_response: { routed: 'node' },
  git_branch_merge_request: { routed: 'client' },
  git_branch_merge_response: { routed: 'node' },
  git_branch_merge_abort_request: { routed: 'client' },
  git_branch_merge_abort_response: { routed: 'node' },
  git_stash_save_request: { routed: 'client' },
  git_stash_save_response: { routed: 'node' },
  git_stash_list_request: { routed: 'client' },
  git_stash_list_response: { routed: 'node' },
  git_stash_pop_request: { routed: 'client' },
  ...
  git_conflict_resolve_request: { routed: 'client' },
  git_conflict_resolve_response: { routed: 'node' },
  ...
  github_pat_connect_request: { routed: 'client' },
  github_pat_connect_response: { routed: 'node' },
  ...
  session_template_list_get: { routed: 'client' },
  session_template_list_set: { routed: 'client' },
  session_template_list_result: { routed: 'node' },
  snippet_list_get: { routed: 'client' },
  snippet_list_set: { routed: 'client' },
  snippet_list_result: { routed: 'node' },
  ...
  review_comment_status: { routed: 'node' },
  pr_merge_request: { routed: 'client' },
  pr_merge_result: { routed: 'node' },
